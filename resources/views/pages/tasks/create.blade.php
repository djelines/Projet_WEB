    ...
    <div class="max-w-3xl mx-auto mt-4 !shadow-xl bg-slate-50 rounded-2xl border-6 dark:bg-[--tw-page-bg-dark] ">
        ...
        <form action="{{ route('tasks.store') }}" method="POST" class="space-y-4 p-8 bg-white dark:bg-[--tw-page-bg-dark] rounded-xl shadow-lg">
            ...
            <div class="space-y-2">
                ...
                <input type="text" name="title" id="title" value="{{ old('title') }}" class="w-full px-4 py-3 border rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" placeholder="Entrez un titre..."> @error('title')
            ...
            <div class="space-y-2">
                ...
                <textarea name="description" id="description" rows="4" class="w-full px-4 py-3 border border-gray-300 rounded-lg shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200" placeholder="Ajoutez des détails..."></textarea>
                @error('description')
                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                @enderror
            </div>
            ...
            <div class="space-y-2">
                ...
                <select name="category" id="category" class="w-full px-4 py-3 border border-gray-300 rounded-lg dark:bg-[--tw-page-bg-dark] shadow-sm bg-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200">
            ...
            <div class="flex flex-row items-end justify-end pt-4 border-gray-200 gap-4">
                <!-- Back -->
                <a href="{{ route('tasks.index') }}" class="bg-purple-700 hover:bg-purple-900 px-4 py-2 rounded-lg !text-white text-sm font-semibold transition duration-300 ease-in-out transform hover:scale-105 uppercase">
                        ← Revenir
                    </a>
