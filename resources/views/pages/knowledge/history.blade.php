<x-app-layout>
    ...
    <div class="max-w-6xl mx-auto mt-12 px-4 sm:px-6 lg:px-8">
                ...
                <tbody class="bg-white dark:bg-[--tw-page-bg-dark] divide-y divide-gray-100">
                    ...
                    <tr class="hover:bg-sky-50 transition duration-200">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-center">
                            <a href="{{ route('knowledge.result', $result->id) }}" class="inline-block bg-indigo-600 hover:bg-indigo-900 !text-white text-sm font-semibold px-4 py-2 rounded-lg transition duration-300">
                            Voir les réponses
                        </a>
                        </td>
                    </tr>
        ...
        <div class="mt-8 text-center">
            <a href="{{ route('knowledge.show', $assessment->id) }}" class="inline-block bg-pink-600 hover:bg-pink-700 !text-white px-5 py-2.5 text-sm font-semibold rounded-lg shadow-md transition transform hover:scale-105">
            Revenir au QCM
        </a>
        </div>
    </div>
