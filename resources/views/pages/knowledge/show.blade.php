<x-app-layout>
    ...
    <!-- Section: General information about the assessment -->
    <div class="relative bg-white dark:bg-[--tw-page-bg-dark] shadow-md rounded-xl p-6 mb-8 border-2 border-gray-200">
        ...
        <!-- Individual cards for assessment details -->
    ...
    <hr>
    <!-- Section for admin: View result history -->
    ...
    <div class="bg-white dark:bg-[--tw-page-bg-dark] shadow-md rounded-xl p-6">
        ...
        <!-- Section for admins: List of MCQ questions -->
        ...
        <!-- Section for students: Answer the MCQ -->
