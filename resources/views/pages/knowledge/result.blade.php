<x-app-layout>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="flex justify-between items-center mb-6">
            <h1 class="text-2xl font-semibold text-gray-800">Liste des Bilans de Compétence</h1> @can('create', \App\Models\Assessment::class)
        ...
        <div class="flex justify-end mb-4 gap-4">
            <a href="{{ route('knowledge.index', ['sort' => $order === 'asc' ? 'desc' : 'asc', 'sort_by' => 'created_at']) }}" class="inline-block !bg-pink-500 !text-white text-sm px-4 py-2 rounded-lg shadow hover:scale-105 transform transition duration-300">
                Trier par date
            </a>

            <a href="{{ route('knowledge.index', ['sort' => $order === 'asc' ? 'desc' : 'asc', 'sort_by' => 'id']) }}" class="inline-block !bg-teal-500 !text-white text-sm px-4 py-2 rounded-lg shadow hover:scale-105 transform transition duration-300">
                Trier par ID
            </a>
        </div>
